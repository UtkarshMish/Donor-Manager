...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  if ($_POST['delete_item']) {
    ...
    $sql = "DELETE FROM `donations` WHERE donation_id ='$oid'";
    if (mysqli_query($conn, $sql)) {
      header("location:/all_donation.php");
    } else {
    ...
    <section>
      <div class="container">
        <div class="row ">
          <div class="col s12">
            <ul class="tabs">
              <li class="tab col s6"><a class="active green-text" href="#test1">Total Donations Made</a></li>
            ...
            <table class="grey lighten-4">
              <thead>
                <tr>
                  ...
                  <th class="black-text">Delete donation</th>
                </tr>
              </thead>
                ...
                ?>
                    <td>
                      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                        <button type="submit" class="btn waves-effect waves-light pink white-text darken-1" name="delete_item" value="<?php echo $donation['donation_id'] ?> ">Delete</button>
